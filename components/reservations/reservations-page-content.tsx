...
/** @summary Renderiza reservas para tenant o una sucursal explícita sin querystrings de identidad. */
export async function ReservationsPageContent({ branchSlug }: { branchSlug?: string }) {
