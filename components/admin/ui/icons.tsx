...
const paths: Record<IconName, string> = {
  ...
  sparkles: '<path d="M12 3l1.9 4.6L18.5 9.5l-4.6 1.9L12 16l-1.9-4.6L5.5 9.5l4.6-1.9L12 3z"/><path d="M19 15l.8 1.9 1.9.8-1.9.8L19 20.4l-.8-1.9-1.9-.8 1.9-.8L19 15z"/>',
  menu: '<path d="M4 7h16M4 12h16M4 17h16"/>',
  filter: '<path d="M3 5h18l-7 8v6l-4 2v-8L3 5z"/>',
  star: '<path d="M12 3l2.8 5.7 6.2.9-4.5 4.4 1.1 6.2L12 17.8 6.4 20.2l1.1-6.2L3 9.6l6.2-.9L12 3z"/>',
  "star-filled": '<path fill="currentColor" d="M12 3l2.8 5.7 6.2.9-4.5 4.4 1.1 6.2L12 17.8 6.4 20.2l1.1-6.2L3 9.6l6.2-.9L12 3z"/>',
  heart: '<path d="M12 20s-7-4.4-9.2-8.5A4.6 4.6 0 0 1 12 6.6a4.6 4.6 0 0 1 9.2 4.9C19 15.6 12 20 12 20z"/>',
  "heart-filled": '<path fill="currentColor" d="M12 20s-7-4.4-9.2-8.5A4.6 4.6 0 0 1 12 6.6a4.6 4.6 0 0 1 9.2 4.9C19 15.6 12 20 12 20z"/>',
  ...
  phone: '<path d="M5 4h4l1.5 4-2 1.5a12 12 0 0 0 6 6l1.5-2 4 1.5v4a2 2 0 0 1-2 2A16 16 0 0 1 3 6a2 2 0 0 1 2-2z"/>',
  ...
  users: '<circle cx="9" cy="8" r="3.2"/><path d="M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6M16 5.3a3.2 3.2 0 0 1 0 5.4M18 14c2.5.8 4 2.9 4 6"/>',
  "chef-hat": '<path d="M6 15a4 4 0 0 1-1.5-7.7A4.5 4.5 0 0 1 12 6a4.5 4.5 0 0 1 7.5 1.3A4 4 0 0 1 18 15v4H6v-4z"/><path d="M6 16h12"/>',
  glass: '<path d="M7 3h10l-1 17a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2L7 3z"/><path d="M7.5 11h9"/>',
  coffee: '<path d="M4 8h11v6a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4V8z"/><path d="M15 10h1.5a2.5 2.5 0 0 1 0 5H15M4 19h11M7 6V4M10 6V4M13 6V4"/>',
  ...
  image: '<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="10" r="1.6"/><path d="M4 17l4.5-4.5 3 3L16 11l4 4"/>',
  clock: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/>',
  dollar: '<circle cx="12" cy="12" r="9"/><path d="M12 6v12M15.5 8.5c-.8-1-2.1-1.6-3.5-1.6-2 0-3.5 1-3.5 2.6 0 3.7 7 1.6 7 5.1 0 1.6-1.5 2.6-3.5 2.6-1.4 0-2.7-.6-3.5-1.6"/>',
  ...
  repeat: '<path d="M3 12a9 9 0 0 1 15.5-6.5L21 8M21 12a9 9 0 0 1-15.5 6.5L3 16"/><path d="M17 3l4 5h-4M7 21l-4-5h4"/>',
  edit: '<path d="M16.5 3.5l4 4L8 20H4v-4L16.5 3.5z"/>',
  wallet: '<path d="M4 6a2 2 0 0 1 2-2h13v4"/><path d="M4 6v12a2 2 0 0 0 2 2h13V8h-2a4 4 0 0 0-4 4 4 4 0 0 0 4 4h2"/><path d="M17 12h.01"/>',
  printer: '<path d="M6 9V3h12v6"/><path d="M6 15h12a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2z"/><path d="M6 19h12v-4H6v4z"/>',
  ...
  inbox: '<path d="M3 13h5l2 3h4l2-3h5l-1.5 6a2 2 0 0 1-2 1.5H6.5a2 2 0 0 1-2-1.5L3 13z"/><path d="M3 13V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8"/>',
  eye: '<path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12z"/><circle cx="12" cy="12" r="3"/>',
  "external-link": '<path d="M14 4h6v6M20 4 10 14"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',
  ...
  loader: '<path d="M12 3v4M12 17v4M4.9 4.9l2.8 2.8M16.3 16.3l2.8 2.8M3 12h4M17 12h4M4.9 19.1l2.8-2.8M16.3 7.7l2.8-2.8"/>',
  ...
  money: '<rect x="3" y="6" width="18" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6.5 9v6M17.5 9v6"/>',
  save: '<path d="M5 3h11l5 5v13H5V3z"/><path d="M8 3v6h8V3M8 21v-7h8v7"/>',
  mail: '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3.5 7l8.5 6 8.5-6"/>',
  flame: '<path d="M12 3c.5 3.5-3 5-3 8a3 3 0 0 0 6 0c0-1.5-.7-2.5-1.3-3.5.8 1 3 2.4 3 5.5A5.5 5.5 0 0 1 12 21a5.5 5.5 0 0 1-5.5-5.5c0-4 3.5-6 5.5-9z"/>',
  "wifi-off": '<path d="M2 8.5a15 15 0 0 1 6.5-3.7M9.5 5.2A15 15 0 0 1 22 8.5M5 12a10 10 0 0 1 3.5-2.6M12.5 9a10 10 0 0 1 6.5 3"/><path d="M8.5 15.5a5.5 5.5 0 0 1 7 0M12 19h.01M3 3l18 18"/>',
