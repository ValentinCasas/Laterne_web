        ...
        fs.readdir(imagesFolderPath, (err, files) => {
            if (err) {
                ...
                const images = imageFiles.map(file => ({
                    name: file,
                    path: `/images/images_categories/${file}`
                }));

                res.render('pages/category-create', { Categories: categories, Images: images });
            }
        });
    } catch (err) {
    ...
    try {
        ...
        fs.readdir(imagesFolderPath, (err, files) => {
            if (err) {
                ...
                res.render('pages/category-edit', { Category: category, Images: images });
            }
        });
