...
export const goProducts = async (req, res) => {
    try {
        ...
        res.render('pages/product-create', { Products: products, Categories: categories });
    } catch (error) {
...
export const goEditProduct = async (req, res) => {
    ...
    try {
        ...
        res.render('pages/product-edit', { Product: product, Categories: categories, ProductCategory: productCategory });
