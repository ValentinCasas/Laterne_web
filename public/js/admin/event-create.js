...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <div class="card relative overflow-hidden my-4 flex border bg-white shadow-xl rounded-3xl" id="card-${result.Event.id}">
    ...
    ${result.Event.imageUrl ? `<img src="/images/images_event/${result.Event.imageUrl}" alt="${result.Event.name}" class="w-1/3  h-40 mb-10 object-contain mr-2 rounded-l-t-lg">` : ''}
