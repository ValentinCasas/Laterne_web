...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <div class="grid grid-cols-1 card relative bg-white shadow-xl rounded-3xl overflow-hidden mb-10 flex border" id="card-${result.Product.id}">
    ...
    <img src="${result.Product.imageUrl === 'product_default.png' ? '/images/image_defect/product_default.png' : '/images/images_product/' + result.Product.imageUrl}" alt="${result.Product.name}" class="w-full h-48 object-contain rounded-t-lg">
