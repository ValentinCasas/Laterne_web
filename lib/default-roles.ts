...
export const DEFAULT_TENANT_ROLES: DefaultRoleDefinition[] = [
  ...
  },
  {
    ...
    description: "Administra pedidos, cocina y mesas.",
    permissionKeys: ["admin.access", "order.manage", "table.manage", "kitchen.manage"],
  },
  {
    key: "camarero",
    name: "Camarero",
    description: "Toma pedidos, gestiona mesas y atiende clientes.",
    permissionKeys: [
      "admin.access",
      "order.manage",
      "table.manage",
  ...
  },
  {
    key: "cocina",
    name: "Cocina",
    description: "Opera el KDS, gestiona comandas y estaciones.",
    permissionKeys: [
      "admin.access",
      "order.manage",
      "kitchen.manage",
  ...
  },
  {
    key: "caja",
    name: "Caja",
    description: "Gestiona cobros, pagos y cuenta corriente.",
    permissionKeys: [
      "admin.access",
      "order.manage",
      "finance.view",
  ...
  },
  {
    key: "encargado",
    name: "Encargado",
    description: "Supervisión operativa completa: pedidos, stock, compras y personal.",
    permissionKeys: [
      "admin.access",
      "order.manage",
      "table.manage",
