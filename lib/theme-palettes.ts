...
export const palettePresets: PalettePreset[] = [
  {
    key: "menuclick-dark",
    name: "MenuClick Dark",
    description: "Rosa energético sobre grafito profundo.",
    baseMode: "dark",
    primary: "#ec4899",
    secondary: "#f5c542",
    accent: "#f9a8d4",
  ...
  },
  {
    key: "grafito",
    name: "Grafito",
    description: "Neutros sobrios con acento azul mineral.",
    baseMode: "dark",
    primary: "#60a5fa",
    secondary: "#a5b4fc",
    accent: "#bfdbfe",
  ...
  },
  {
    key: "medianoche",
    name: "Medianoche",
    description: "Azul profundo y violeta para una identidad nocturna.",
    baseMode: "dark",
    primary: "#818cf8",
    secondary: "#38bdf8",
    accent: "#c4b5fd",
  ...
  },
  {
    key: "bosque",
    name: "Bosque",
    description: "Verdes frescos con crema y grafito.",
    baseMode: "dark",
    primary: "#34d399",
    secondary: "#a3e635",
    accent: "#d9f99d",
  ...
  },
  {
    key: "borgona",
    name: "Borgoña",
    description: "Bordó elegante, rosa viejo y crema.",
    baseMode: "dark",
    primary: "#be123c",
    secondary: "#fb7185",
    accent: "#fecdd3",
  ...
  },
  {
    key: "oceano",
    name: "Océano",
    description: "Azules limpios para una experiencia luminosa.",
    baseMode: "light",
    primary: "#0369a1",
    secondary: "#0891b2",
    accent: "#0e7490",
  ...
  },
  {
    key: "crema",
    name: "Crema",
    description: "Cálida y luminosa, con terracota controlado.",
    baseMode: "light",
    primary: "#b45309",
    secondary: "#d97706",
    accent: "#92400e",
  ...
  },
  {
    key: "carbon",
    name: "Carbón",
    description: "Negro suave y naranja ámbar de alto contraste.",
    baseMode: "dark",
    primary: "#fb923c",
    secondary: "#facc15",
    accent: "#fed7aa",
...
/**
 * @summary Valida contraste, formato y completitud de una paleta visual.
 */
export function validatePalette(colors: PaletteColors) {
  const errors: string[] = [];
  if (contrastRatio(colors.text, colors.background) < 4.5)
    errors.push("El texto principal no contrasta suficientemente con el fondo.");
  if (contrastRatio(colors.textMuted, colors.background) < 3)
    errors.push("El texto secundario necesita más contraste.");
  if (contrastRatio(colors.text, colors.surface) < 4.5)
    errors.push("El texto no contrasta suficientemente con la superficie.");
  if (contrastRatio(colors.primary, colors.background) < 2.5)
    errors.push("El color principal no se distingue del fondo.");
  return errors;
}
...
/**
 * @summary Convierte colores heredados a la estructura actual de paletas.
 */
...
/**
 * @summary Obtiene un preset de paleta por su clave.
 */
