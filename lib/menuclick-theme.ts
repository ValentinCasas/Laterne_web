...
export const menuClickPresets: MenuClickTheme[] = [
  {
    key: "original",
    name: "MenuClick Original",
    description: "Lima eléctrica, cian y grafito.",
    baseMode: "dark",
    primary: "#e8ff6a",
    secondary: "#67e8f9",
    accent: "#f0abfc",
  ...
  },
  {
    key: "grafito",
    name: "Grafito",
    description: "Azul mineral sobre neutros sobrios.",
    baseMode: "dark",
    primary: "#60a5fa",
    secondary: "#a5b4fc",
    accent: "#bfdbfe",
  ...
  },
  {
    key: "nocturno",
    name: "Nocturno",
    description: "Violeta y azul para una marca profunda.",
    baseMode: "dark",
    primary: "#a78bfa",
    secondary: "#38bdf8",
    accent: "#f0abfc",
  ...
  {
    key: "azul-tecnologico",
    name: "Azul tecnológico",
    description: "Cian y azul eléctrico, claro y preciso.",
    baseMode: "dark",
    primary: "#22d3ee",
    secondary: "#3b82f6",
    accent: "#93c5fd",
  ...
  },
  {
    ...
    description: "Violeta intenso con coral controlado.",
    baseMode: "dark",
    primary: "#c084fc",
    secondary: "#fb7185",
    accent: "#f5d0fe",
  ...
  {
    key: "claro-profesional",
    name: "Claro profesional",
    description: "Azul tinta sobre superficies luminosas.",
    baseMode: "light",
    primary: "#1d4ed8",
    secondary: "#0891b2",
    accent: "#0e7490",
...
/**
 * @summary Obtiene un preset visual de MenuClick por su clave.
 */
...
/**
 * @summary Convierte una configuración persistida en un tema válido.
 */
export function menuClickThemeFromRecord(record: {
  name: string;
  ...
  return {
    key: record.presetKey ?? "custom",
    name: record.name,
    description: "Identidad global de MenuClick.",
    baseMode: record.baseMode === "light" ? "light" : "dark",
