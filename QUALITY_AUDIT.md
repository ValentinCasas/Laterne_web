...
- **Archivos corregidos**: `components/products/model-experience.tsx`, `components/orders/checkout-form.tsx`, `lib/branch.ts`, `app/admin/[resource]/page.tsx` (2 fallbacks), `components/products/model-experience.tsx`, `components/orders/checkout-form.tsx`.
...
#### QA-019: `laterne.sql` seed data con `product_default.png` hardcodeado (100+ filas)
